...
- Save any selected cover as a validated PNG to a user-chosen device folder for
  manual selection in launchers that do not consume the bridge's shared artwork
  URI.
